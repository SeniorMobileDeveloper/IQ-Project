...
- (NSInteger)numberOfPhotos {
   NSInteger count = [m_photoArray count];
   return count;
}
...
- (UIImage *)imageAtIndex:(NSInteger)index {
    Photos *item = [m_photoArray objectAtIndex:index];
    UIImage *image = [[UIImage alloc] initWithData:[item valueForKey:@"photo_image"]];
    return image;
}
...
-(void) deleteImageAtIndex:(NSInteger)index
{
    ...
    NSManagedObjectContext *context = appDelegate.managedObjectContent;
    [context deleteObject:[m_photoArray objectAtIndex:index]];
    ...
    [m_photoArray removeObjectAtIndex:index];
}
